...
(function (global) {
  ...
  /**
   * @param {{ascii:string,color?:string,preview_ascii?:string,time?:number,mine?:boolean,id?:string,isAnimated?:boolean,ironBars?:boolean,hoverOutline?:string,alphaMask?:string,frameMaskKind?:string,previewAspect?:string,frameCount?:number,fps?:number,durationMs?:number}} photo 单条用户作品；默认 `mine: true`；无 `id` 时生成新 id。动画帧仅存云端，本地仅存元数据。
   */
  function prependUserPhoto(photo) {
    var list = loadUserPhotos();
    /** @type {{ascii:string,color:string,time:number,mine:boolean,id:string,preview_ascii?:string,isAnimated?:boolean,ironBars?:boolean,hoverOutline?:string,alphaMask?:string,frameMaskKind?:string,previewAspect?:string,frameCount?:number,fps?:number,durationMs?:number}} */
    var row = {
